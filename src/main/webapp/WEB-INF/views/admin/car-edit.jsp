...
<div class="card">
	...
	<div class="card-body">
		<form class="needs-validation" action="/admin/carEdit" method="post" novalidate>
			<div class="form-row">
				<div class="col-md-6 mb-3">
					...
					<select class="form-control" id="validationCustom01" name="carName" required>
						<option selected>${car.manufacturer}</option>
			...
			<div class="form-row">
				...
				<div class="col-md-6 mb-3">
					...
					<input type="text" class="form-control" id="validationCustom04" value="${car.stateNumber}"
						placeholder="<mytag:message key="page.admin.car_registration.state_number" />" name="stateNumber" required>
					<div class="valid-feedback">
						<mytag:message key="page.admin.car_registration.ok" />
						!
					</div>
			...
			<div class="form-row mb-3">
				...
				<div class="input-group">
					...
					<input type="number" class="form-control" id="validationRentValue" value="${car.rentValuePerDay}"
			...
			<div class="form-row mb-3">
				...
				<textarea class="form-control" id="validationTextarea"
					...
					name="equipmentInformation">${car.equipmentInformation}</textarea>
			</div>
			<div class="form-row mb-3">
				<div class="custom-control custom-checkbox my-1 mr-sm-2">
					<input type="checkbox" class="custom-control-input" id="acCheck" name="airConditioner" value="true"
						<c:if test="${car.airConditioner}">checked</c:if>>
				...
				<div class="custom-control custom-checkbox my-1 mr-sm-2">
					<input type="checkbox" class="custom-control-input" id="navigationCheck" name="navigation" value="true"
						<c:if test="${car.navigation}">checked</c:if>>
			...
			<button class="btn btn-primary" type="submit">
				<mytag:message key="page.admin.car_edit.update" />
			</button>
		</form>
	</div>
</div>
