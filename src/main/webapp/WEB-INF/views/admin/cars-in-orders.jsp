...
<div class="row scroll">
	<div class="col">
		<div class="card">
				...
				<div class="row">
					...
					<div class="col-md-10">
						<ul class="nav nav-pills justify-content-center">
							<li class="nav-item"><a class="nav-link" href="/admin/cars/all">
			...
			<div class="card-body">
				<form action="/admin/cars/inOrders" id='form'>
					<div class="row scroll">
						<div class="col-2">
							<div class="card">
								<div class="card-header">
								...
								<table class="table table-hover">
									<thead class="thead-light ">
										<tr>
											...
											<th scope="col"><mytag:message key="page.admin.home.rent_value" /> <br> <mytag:message key="page.admin.home.day" /></th>
			...
			function(e) {
				...
				$(this).attr(
						...
						$('#form').serialize() + "&page="
								+ $(this).data("page"));
				$(location).attr('href',
						"/admin/cars/inOrders?" + $(this).attr("href"));
			});
</script>
