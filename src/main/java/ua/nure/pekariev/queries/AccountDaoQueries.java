...
public final class AccountDaoQueries {
	...
	public static final String CREATE_ACCOUNT_WITH_LOGIN_PASS_QUERY = "INSERT INTO account(email, password, first_name, last_name) values(?, ?, ?, ?)";
	public static final String INSERT_ROLE_FOR_CREATED_ACCOUNT_QUERY = "INSERT INTO account_role(id_account) values(?)";
